    ...
    while True: # main game loop
       ...
       # if wormCoords[HEAD]['x'] == wormCoords1[HEAD]['x'] or wormCoords[HEAD]['x'] == wormCoords1[HEAD]['y'] or wormCoords[HEAD]['y'] == wormCoords1[HEAD]['x'] or wormCoords[HEAD]['y'] == wormCoords1[HEAD]['y']:
        ...
        if wormCoords[HEAD]['x'] == apple['x'] and wormCoords[HEAD]['y'] == apple['y']:
            ...
            apple3 = getRandomLocation()
            n1=n1+1
        elif wormCoords[HEAD]['x'] == superapple1['x'] and wormCoords[HEAD]['y'] == superapple1['y']:
            superapple1={'x':-2, 'y': -2}
            score1=score1+5
            n1=0
        elif wormCoords[HEAD]['x'] == superapple2['x'] and wormCoords[HEAD]['y'] == superapple2['y']:
            superapple2 = {'x': -2, 'y': -2}
            score1 = score1 - 3
            n2 = 0
        ...
        if wormCoords1[HEAD]['x'] == apple['x'] and wormCoords1[HEAD]['y'] == apple['y']:
            ...
            apple3 = getRandomLocation()
            n2=n2+1
        elif wormCoords1[HEAD]['x'] == superapple2['x'] and wormCoords1[HEAD]['y'] == superapple2['y']:
            superapple2={'x':-2, 'y': -2}
            score2 = score2 + 5
            n2=0
        elif wormCoords1[HEAD]['x'] == superapple1['x'] and wormCoords1[HEAD]['y'] == superapple1['y']:
            superapple1={'x':-2, 'y': -2}
            score2 = score2 -3
            n1=0
        ...
        if(n1>=5):
            if superapple1['x']==-2 and superapple1['y']==-2:
                superapple1 = getRandomLocation()

            drawApple(superapple1,PINK)
        if(n2>=5):
            if superapple2['x']==-2 and superapple2['y']==-2:
                superapple2 = getRandomLocation()
            drawApple(superapple2,BLUE)
